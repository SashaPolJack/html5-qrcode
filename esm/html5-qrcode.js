...
var Html5Qrcode = (function () {
    ...
    Html5Qrcode.prototype.foreverScan = function (internalConfig, qrCodeSuccessCallback, qrCodeErrorCallback) {
        ...
        var supportZoom = this.getRunningTrackCameraCapabilities().zoomFeature().isSupported();
        var elementScan = supportZoom ? this.renderedCamera.getSurface() : document.getElementById(this.elementId);
        var widthRatio = supportZoom ? elementScan.videoWidth / elementScan.clientWidth : 1;
        var heightRatio = supportZoom ? elementScan.videoHeight / elementScan.clientHeight : 1;
        if (!this.qrRegion) {
