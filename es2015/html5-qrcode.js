...
export class Html5Qrcode {
    ...
    foreverScan(internalConfig, qrCodeSuccessCallback, qrCodeErrorCallback) {
        ...
        const widthRatio = supportZoom ? elementScan.videoWidth / elementScan.clientWidth : 1;
        const heightRatio = supportZoom ? elementScan.videoHeight / elementScan.clientHeight : 1;
        if (!this.qrRegion) {
